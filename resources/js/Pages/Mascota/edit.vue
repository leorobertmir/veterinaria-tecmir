...
const state = reactive({
  clienteId: props.mascota.clienteId,
  ...
  fechaNacimiento: props.mascota.fechaNacimiento || '',
  peso: props.mascota.peso,
  microchip: props.mascota.microchip || '',
  observaciones: props.mascota.observaciones || '',
  activo: props.mascota.activo
})
...
const handleSubmit = () => {
  ...
  router.put(route('mascotas.update', props.mascota.id), state, {
...
<template>
  <UDashboardPanel id="mascota-edit">
    <template #header>
      <UDashboardNavbar title="Editar Mascota">
        <template #leading>
          <UButton
        ...
        <UCard>
          <template #header>
            <div class="flex items-center gap-3">
              ...
              <div>
                <h2 class="text-lg font-semibold">Editar Mascota</h2>
                <p class="text-sm text-muted">Modifique la informacion de {{ props.mascota.nombre }}</p>
              </div>
            </div>
          </template>
          ...
          <form @submit.prevent="handleSubmit" class="space-y-4">
            ...
            <div class="flex items-center gap-2">
              <UCheckbox v-model="state.activo" label="Mascota activa" />
            </div>
